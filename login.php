				...
				<fieldset class="col-xs-10 col-xs-offset-1">
					...
					<form class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
						<div class="form-group">
							<label class="col-xs-10" for="usuario" ><h4>E-mail</h4></label>
							<?php
                if ( isset($errMSG) ){
                echo $errMSG; ?>
                  <?php
                   ...
                   ?>
							<div class="col-xs-10 col-ms-offset-1">
								<input id="usuario" class="form-control Input" type="email" name="email" value="" placeholder="" value="<?php echo $email; ?>" maxlength="40"/>
						...
						<div class="form-group">
							...
							<div class="col-xs-10 col-ms-offset-1">
								<input  id="password" class="form-control Input" type="password" name="pass" value="" placeholder="" maxlength="15"/>
								<span class="text-danger"><?php echo $passError; ?></span>
							</div>

							<div id="form-group" class="col-xs-11 form-group">
								<button  type="submit" name="btn-login" class="btn btn-danger center-block">Login</button>
